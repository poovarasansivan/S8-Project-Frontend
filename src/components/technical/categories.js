    ...
    async function fetchData() {
      try {
        const response = await fetch(
          "http://localhost:5000/skillStats/poovarasan12"
        );
        ...
        appendData(data.data.matchedUser.tagProblemCounts.fundamental, "Fundamental");
        appendData(data.data.matchedUser.tagProblemCounts.intermediate, "Intermediate");
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  {["S No", "Category", "Difficulty", "Problems Solved"].map((header) => (
                    <th
